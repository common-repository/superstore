...
/**
 * Superstore top rated products widget class
 */
class TopRatedProducts extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname'   => 'woocommerce widget_products superstore-top-rated-products',
			'description' => 'To display top rated products of a store',
		);
		parent::__construct( 'superstore-top-rated-products', 'Superstore: Top rated products', $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		$r = superstore()->product->get_top_rated_products( $args );
	...
	public function form( $instance ) {
		$title           = isset( $instance['title'] ) ? esc_attr( $instance['title'] ) : __( 'Top Rated Products', 'superstore' );
