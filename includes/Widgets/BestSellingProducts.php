...
/**
 * Superstore best selling products widgets class
 */
class BestSellingProducts extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname'   => 'woocommerce widget_products superstore-best-selling-products',
			'description' => 'To display best selling products of a store',
		);
		parent::__construct( 'superstore-best-selling-products', 'Superstore: Best selling products', $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		$r = superstore()->product->get_best_selling_products( $args );
	...
	public function form( $instance ) {
		$title           = isset( $instance['title'] ) ? esc_attr( $instance['title'] ) : __( 'Best Selling Products', 'superstore' );
