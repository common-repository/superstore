...
/**
 * Superstore featured products widget class
 */
class FeaturedProducts extends WP_Widget {
	...
	public function __construct() {
		$widget_ops = array(
			'classname'   => 'woocommerce widget_products superstore-featured-products',
			'description' => 'To display featured products of a store',
		);
		parent::__construct( 'superstore-featured-products', 'Superstore: Featured products', $widget_ops );
	}
	...
	public function widget( $args, $instance ) {
		...
		$r = superstore()->product->get_featured_products( $args );
	...
	public function form( $instance ) {
		$title           = isset( $instance['title'] ) ? esc_attr( $instance['title'] ) : __( 'Featured Products', 'superstore' );
